...
class MainActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tvExponentiation: TextView = findViewById(R.id.tvExponentiation)
        tvExponentiation.setOnClickListener {
            tvExpression.text = tvExpression.text.toString() + "^"
        }

        val tvExp: TextView = findViewById(R.id.tvExp)
        tvExp.setOnClickListener {
            tvExpression.text = tvExpression.text.toString() + "e^"
        }
        ...
        val tvClosedBracket: TextView = findViewById(R.id.tvClosedBracket)
        tvClosedBracket.setOnClickListener {
            tvExpression.text = tvExpression.text.toString() + ")"
        }
